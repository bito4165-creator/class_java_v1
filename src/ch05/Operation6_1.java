...
public class Operation6_1 {
    ...
    public static void main(String[] args) {
        ...
        boolean freeDelivery = (cartTotal >= 30000) && (isMember == true);
        ...
        System.out.println("할인 조건 확인 : " + canDiscount);

        // 3. 구매 제한 조건: 나이가 19세 미만이고 회원이 아닌 경우
        boolean limitBuy = (userAge < 19) && (isMember == false);
        System.out.println("구매 제한 조건 확인 : " + limitBuy);

        // 4. 이벤트 참여 조건: 장바구니 총액이 5만 원 미만이거나 쿠폰이 3개 미만
        boolean isEvent = (cartTotal < 50000) || (couponCount < 3);
        System.out.println("이벤트 참여 조건 확인 : " + isEvent);
