 ...
 * 요청이 들어올 때마다 서버가 새로 만들어 handle()에 넘겨주고 끝나버린다
 *
...
public class SimpleHttpServer {
    ...
    static final String TYPE_JSOM = "application/json; charset=UTF-8";
    ...
    public static void main(String[] args) throws IOException {
         ...
         * 둘다 이 포트로 들어오는 연결을 내가 받겠다. 라고 운영체제에 등록하는 일이다.
        ...
        // main이 끝나도 프로그램이 종료되지 않는 이유는 HttpServer가 만든 스레드가 살아 있기 때문이다.
        // 멈추려면 종료 버튼 누른다.
        server.start();
    ...
    static void sendResponse(HttpExchange exchange, int statusCode, String contentType, String bodyText) throws IOException {
        ...
        // getResponseBody()는 OutputStream 이므로 문자열이 아니라 바이트를 쓰고 있다.
    ...
    static void sendJson(HttpExchange exchange, int statusCode,Object data) throws IOException {
        sendResponse(exchange, statusCode, TYPE_JSOM, new Gson().toJson(data));
    }
