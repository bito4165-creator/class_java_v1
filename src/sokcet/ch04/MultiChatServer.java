...
public class MultiChatServer {
    ...
    // Vector 는 멀티스레드 환경에서 안전한 동작을 한다. (모든 메서드에 동기화처리 되어있음.)
    ...
    private static class ClientHandler extends Thread {
        ...
        public void run() {
            try {
                ...
                // 추후 브로드 캐스트(접속자들에게 방송하기 위해서 생성된 출력 스트림을 자료구조에 저장)
                ...
                // 서버측에서 관리하고 있는 자료구조에서 출력 스틀미을 제거 해야한다.
        ...
        private void broadcast(String msg) {
            for (PrintWriter w : clientWriterList) {
                // 자료구조에 저장된 출력 스트림을 전체 꺼내서 하나씩 메세지 전송
                w.println(msg);
            }
        }
